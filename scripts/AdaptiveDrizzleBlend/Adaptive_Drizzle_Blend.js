...
function AppDialog(params)
{
   ...
   var youtube_Label = new Label( this );
   youtube_Label.useRichText = true;
   youtube_Label.text = '<a    href="https://www.youtube.com/@AstroVecinos">More info in YouTube:@AstroVecinos</a>';
   youtube_Label.toolTip = "Open the AstroVecinos YouTube channel.";
   youtube_Label.openExternalLinks = true; // si está disponible en tu PI
